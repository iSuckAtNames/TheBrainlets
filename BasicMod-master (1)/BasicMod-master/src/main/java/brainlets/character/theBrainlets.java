package brainlets.character;

import basemod.abstracts.CustomEnergyOrb;
import basemod.abstracts.CustomPlayer;
import basemod.animations.AbstractAnimation;
import brainlets.cards.Basic.ChooseYourStart;
import brainlets.cards.Basic.Defend;
import brainlets.cards.Basic.MarkThePath;
import brainlets.cards.Basic.Strike;
import brainlets.relics.PingForRun;
...
public class theBrainlets extends CustomPlayer {
    //Stats
    ...
    //Strings
    private static final String ID = makeID("Brainlets"); //This should match whatever you have in the CharacterStrings.json file
    ...
    public static class Enums {
        ...
        @SpireEnum
        public static AbstractPlayer.PlayerClass TheBrainlets;
        @SpireEnum(name = "BRAINLETS_PURPLE_ORANGE") // These two MUST match. Change it to something unique for your character.
        public static AbstractCard.CardColor CARD_COLOR;
        @SpireEnum(name = "BRAINLETS_PURPLE_ORANGE") @SuppressWarnings("unused")
    ...
    public theBrainlets() {
        super(NAMES[0], Enums.TheBrainlets,
                ...
                new AbstractAnimation() { //Change the animation line to this.
                    ...
                    initializeClass(characterPath("theBrainletsTogether.png"),
                    SHOULDER_2,
                    SHOULDER_1,
                    CORPSE,
                    getLoadout(),
    ...
    public ArrayList<String> getStartingDeck() {
        ...
        retVal.add(ChooseYourStart.ID);
        retVal.add(MarkThePath.ID);
        return retVal;
    }
