...
public class UploadTroublePower extends BasePower implements CloneablePowerInterface, OnReceivePowerPower {
    ...
    {
        if (power.ID.equals(UploadTroublePower.POWER_ID)) {
            this.freeCardsThisTurn += power.amount;
        }
        return true;
    }
