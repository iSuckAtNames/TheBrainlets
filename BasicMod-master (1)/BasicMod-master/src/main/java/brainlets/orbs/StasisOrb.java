package brainlets.orbs;

import brainlets.BasicMod;
import brainlets.actions.ReturnStasisCardToHandAction;
import brainlets.actions.StasisEvokeIfRoomInHandAction;
...
public class StasisOrb extends AbstractOrb {
    ...
    public static final String ID = makeID("StasisOrb");
    ...
    public StasisOrb(AbstractCard card, CardGroup source, boolean selfStasis) {
        ...
        if(this.stasisCard instanceof BaseCard){
            ((BaseCard) this.stasisCard).belongedOrb=this;
        }
        ...
        this.stasisCard.tags.add(BasicMod.STASISGLOW);
    ...
    public void applyFocus() {
        //Stasis is not affected by Focus
    }
    ...
    public void onEvoke() {
        ...
        if (this.stasisCard.hasTag(BasicMod.VOLATILE)) {
    ...
    public void update() {
        ...
        if (stasisStartEffect == null || stasisStartEffect.isDone) {
            ...
            if (this.hb.hovered) {
                ...
                this.stasisCard.targetDrawScale = theBrainlets.stasisCardRenderScale;
            }
        }
